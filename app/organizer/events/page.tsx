        ...
        {events && events.length > 0 ? (
          ...
          <div className="divide-y divide-border">
            <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-background/50 transition-colors">
              <div className="flex items-center gap-6">
                <div className="w-24 h-24 rounded-xl overflow-hidden shrink-0 border border-border">
                  <img src="/images/hero-concert.jpg" alt="Accra Tech Summit" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h3 className="text-xl font-bold font-serif mb-1">Accra Tech Summit</h3>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-sm text-muted font-medium">
                    <span className="flex items-center gap-1.5"><CalendarDays size={16} /> Oct 12, 2026</span>
                    <span className="flex items-center gap-1.5"><MapPin size={16} /> AICC, Accra</span>
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-xs font-bold px-3 py-1.5 rounded-md uppercase bg-green-100 text-green-800">
                  PUBLISHED
                </span>
                <button className="px-4 py-2 bg-background border border-border rounded-lg text-sm font-bold hover:border-primary transition-colors">
                  Edit
                </button>
              </div>
            </div>
            ...
            <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-background/50 transition-colors">
              <div className="flex items-center gap-6">
                <div className="w-24 h-24 rounded-xl overflow-hidden shrink-0 border border-border">
                  <img src="/images/culture-fest.jpg" alt="Detty December Concert" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h3 className="text-xl font-bold font-serif mb-1">Detty December Concert</h3>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-sm text-muted font-medium">
                    <span className="flex items-center gap-1.5"><CalendarDays size={16} /> Dec 24, 2026</span>
                    <span className="flex items-center gap-1.5"><MapPin size={16} /> Independence Square</span>
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-xs font-bold px-3 py-1.5 rounded-md uppercase bg-gray-100 text-gray-800">
                  DRAFT
                </span>
                <button className="px-4 py-2 bg-background border border-border rounded-lg text-sm font-bold hover:border-primary transition-colors">
                  Edit
